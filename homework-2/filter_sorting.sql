...
--!!!!!!Считаю уместным в заданиях 1 и 2 еще и исключить строки в которых дата отгрузки NULL, видимо эти товары не были отгружены
-- а в условии требуется провести манипуляции именно с выполненными заказами

--Предполагаю, что нам учитывать это не нужно, поэтому показала это только на примере в задании simple_queries.sql